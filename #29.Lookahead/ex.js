...
for patterns further along. This can be useful when you want to search for multiple patterns 
...
but won't actually match it. A positive lookahead is used as (?=...) where the ... is the required part 
that is not matched.
